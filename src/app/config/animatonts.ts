...
export const ASSSEMBLE_ANIMATIONS: AnimationParams[] = [
  ...
  },
  {
    from: 0,
    to: SHIFT * 3,
    componentName: ['TopCover', 'GPSBoard', 'GPSCover', 'GPSBoardWires'],
    position: 'position.y',
  ...
  },
  {
    ...
    rotationCamera: { alpha: Math.PI * 2, beta: Math.PI },
    highlighted: [
      'LeftFrontSupport',
      'RightFrontSupport',
      'RightBackSupport',
        ...
        params: [
          {
            ...
            position: 'position.y',
            tip: `Первым шагом необходимо снять батарею, чтобы обесточить квадрокоптер. Возьмите аккумулятор с обеих сторон,
           нажмите подсвеченные кнопки разблокировки с обеих сторон, затем поднимите его.`,
          },
        ],
