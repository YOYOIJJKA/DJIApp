...
export const ASSSEMBLE_ANIMATIONS: AnimationParams[] = [
  {
    ...
    position: 'position.y',
    tip: 'Первым шагом необходимо снять батарею, чтобы обесточить квадрокоптер, для этого нажмите на подсвеченные кнопки с обеих сторон и потяните батарею вверх',
    name: 'Снятие батареи',
